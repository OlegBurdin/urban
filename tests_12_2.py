...
Launching unittests with arguments python -m unittest D:\proj\pythonProjectUrban\module_12\module_12_2.py in D:\proj\pythonProjectUrban\module_12



{1: 'Usein', 2: 'Nik'}
{1: 'Andrey', 2: 'Nik'}
{1: 'Usein', 2: 'Andrey', 3: 'Nik'}
